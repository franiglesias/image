...
class EffectRotateTest extends EffectTestCase
{
    public function test_it_rotates_image_60_degrees()
    {
        ...
        $test = $this->dispatcher->duplicate($image, 'resources/rotate_60.jpg');
    ...
    {
        $image = $this->dispatcher->get('resources/test640-480.jpg');
        $test = $this->dispatcher->duplicate($image, 'resources/rotate_90.jpg');
    ...
    {
        $image = $this->dispatcher->get('resources/test640-480.jpg');
        $test = $this->dispatcher->duplicate($image, 'resources/rotate_180.jpg');
